 ...
 * the license GPLV3.
 *
 * 本程序的目的是实现koren在SIGKDD'08论文中的gNbr with implicit feedback方法, 使用的数据是movielens的数据
 * The purpose of this program is to implement the global neighborhood based model (with implicit feedback)
